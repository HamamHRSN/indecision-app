...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function handleDeleteOptions() {
            this.setState(function () {
                return { options: [] };
            }); // short for up using () => ({})  because if i use cerlyprecess direct will return empty function () => {}
        }
    }, {
        ...
        value: function render() {
            ...
            var subtitle = 'Put your live in the hand of a computer!...';
...
ReactDOM.render(React.createElement(IndecisionApp /*options={['MyFirst-Item', 'MySecond-Item', 'MyThird-Item']}*/, null), document.getElementById('app'));
